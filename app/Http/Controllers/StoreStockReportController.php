...
class StoreStockReportController extends Controller
{
    ...
    public function storeStockData(Request $request, $storeId){
        ...
        $totalData = Product::join('store_inventories', 'products.id', 'store_inventories.productId')
                ->where([['store_inventories.created_by', Auth::user()->subscriber_id], ['store_inventories.store_id', $storeId]])
                ->count();
        ...
        if(empty($request->input('search.value'))){
            ...
            $totalFiltered = Product::join('store_inventories', 'products.id', 'store_inventories.productId')
                            ->where([['store_inventories.created_by', Auth::user()->subscriber_id], ['store_inventories.store_id', $storeId]])
                            ->where('products.productName','LIKE',"%{$search}%")
                            ->count();
        }
    ...
    public function storeStockDataDefault(Request $request){
        ...
        $totalData = Product::join('store_inventories', 'products.id', 'store_inventories.productId')
                    ->where([['store_inventories.created_by', Auth::user()->subscriber_id], ['store_inventories.store_id', $defaultStore->id]])
                    ->count();
        ...
        // return [ 'data' => json_encode( $json_data), 'storename' => $defaultStore->store_name,
