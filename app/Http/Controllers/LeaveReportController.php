...
class LeaveReportController extends Controller
{
    public function index(){
        ...
        $departments = DB::table('employee_departments')->where('subscriber_id', Auth::user()->subscriber_id)->get();
        return view('report/leave-report', ['employees' => $employees, 'departments' => $departments]);
    }
