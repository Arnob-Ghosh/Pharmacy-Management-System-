...
require __DIR__.'/auth.php';
    ...
    Route::get('/todays-sale-stock/{subscriberId}', 'DashboardAPIController@todaysSaleStock');

    Route::get('/total-stock/{storeId}', 'DashboardAPIController@totalStock');
    Route::get('/incoming-stock/{storeId}', 'DashboardAPIController@incomingStock');
    ...
    Route::get('/store-list/{subscriberId}', 'ProductAPIController@storelist');
    Route::get('/batch-list/{subscriberId}', 'ProductAPIController@batchlist');
...
Route::get('/purchase-date/{subscriberId}', 'AccountController@purcahse_date');
    ...
    //-------------------------------------------Product-----------------------------------------------------------------------------------------
    Route::get('/product-create/{subscriberId}','ProductAPIController@create');
    Route::post('/product-create/{subscriberId}/{storeId}', 'ProductAPIController@store');
    ...
    //Expense
        ...
        //Salary
        Route::post('/salary-create', 'SalaryAPIController@store');
        ...
        Route::post('/profit-calculation-data/{subscriberId}/{storeId}', 'ProfitCalculationAPIController@loadData')->name('profit.calculation.reports.view');
        ...
        //Inserting product to store
        Route::post('/insert-product', 'InsertProductApiController@store');
        Route::get('/all-product', 'InsertProductApiController@list');
        Route::get('/products/{subscriberId}', 'ProductAPIController@allProduct');
