	...
	var t = $('#salary_table').DataTable({
        ...
        columns: [
            ...
            { "render": function ( data, type, row, meta ){
				...
				var totalDeduct = parseFloat(perDaySalary )* parseFloat(totalAbsent)
				var grossSalary = parseFloat(row.grossSalary)
				var netSalary = parseFloat(grossSalary )- parseFloat(totalDeduct)
			...
			{ "render": function ( data, type, row, meta ){
				...
				var totalPresent = parseFloat(row.totalPresent)
				var totalAbsent = parseFloat(row.totalAbsent)
				var absentDeduct = parseFloat(perDaySalary)* parseFloat(totalAbsent )
				var totalDeduct = parseFloat(absentDeduct)+ parseFloat(deduction )
				var grossSalary = parseFloat(row.basic_pay) + parseFloat(row.addition)
				var netSalary = parseFloat(grossSalary)- parseFloat(totalDeduct)
