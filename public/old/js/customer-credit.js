...
$(document).ready(function () {
    ...
    var t = $('#due_table').DataTable({
        ...
        columns: [
            ...
            { "render": function (data, type, row, meta) { var totalPurchase = parseFloat(row.totalPurchase); return parseFloat(totalPurchase).toFixed(2); } },
            { "render": function (data, type, row, meta) { var totalDeposit = parseFloat(row.totalDeposit); return parseFloat(totalDeposit).toFixed(2); } },
            {
                "render": function (data, type, row, meta) {
                    ...
                    if (balance > 0) {
                        ...
                        return -1 * parseFloat(balance).toFixed(2) + ' Cr';
                    }
                }
            },
        ],
