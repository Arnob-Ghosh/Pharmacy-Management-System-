...
$(document).ready(function () {
    var t = $('#product_table').DataTable({
        ...
        columns: [
            ...
            { data: 'productName' },
            { data: 'qty' },
            { "render": function (data, type, row, meta) { var tp = parseFloat(row.price); return tp.toFixed(2);} },
            ...
            { "render": function (data, type, row, meta) { var gt = parseFloat(row.tp); return gt.toFixed(2);} },
        ],
        columnDefs: [
	        {
	            searchable: true,
