...
class CreateWeeklySalaryEmployeesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('weekly_salary_employees', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('weekly_salary_employees');
    }
}
