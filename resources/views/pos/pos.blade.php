			    ...
			    <div class="modal-body">
			        ...
			        <div class="row g-3 align-items-center pt-3">
  					...
  					<div class="row g-3 align-items-center pt-3 ">
  						...
  						<div class="col-4">
						    <input type="number" name="bankamount" class="form-control" id="bankamount" onchange="payFieldsValidation()" placeholder="Bank amount">
						</div>
    	...
    	<div class="modal-content" id="form_div_hold">
			...
			<form id="HoldForm" method="" enctype="multipart/form-data">
			    ...
			    <div class="modal-footer justify-content-center">
			        ...
			        <button id="save_hold" type="button" class="btn btn-info" onclick="dataCollectionForHold()">Save</button>
			    </div>
