            ...
            <div class="row">
	          	<div class="col-lg-12">
		              ...
		              <div class="card-header">
		                	<h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> DEFAULT CATEGORIES</strong></h5>
		              </div>
		              <div class="card-body">
	                    ...
	                    <div class="pt-3">
	                    	<div class="table-responsive">
                                <table id="default_category_table" class="display" width="100%">
												    <thead>
												        <tr>
												            <th>#</th>
												            <th>Category Name</th>
        ...
        <input type="hidden" name="_method" value="PUT">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    <label class="form-label">Category Name<span class="text-danger"><strong>*</strong></span></label>
