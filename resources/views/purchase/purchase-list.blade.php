				...
				<div class="col-lg-12">
			      ...
			      <div class="card-body">
			          ...
			          <div class="pt-3 table-responsive">
						<table id="purchaseProduct_table" class="d-block responsive">
						    <thead>
						        <tr>
						        	<th>#</th>
						            <th>Supplier Name</th>
...
function resetButton(){
    $('#startdate').val('');
    $('#enddate').val('');
	$("#supplier_id").val('default').selectpicker("refresh");
}
    $('#purchaseListForm').on('submit', function(e) {
        ...
        columns: [
            ...
            { "render": function ( data, type, row, meta ){
                 return '<a type="button" class="edit_btn btn btn-info btn-sm" href="/purchase-product-list/' + row.id + '"><i class="fas fa-info-circle"></i> Details</a>';
            } },
        ],
        columnDefs: [
	        {
