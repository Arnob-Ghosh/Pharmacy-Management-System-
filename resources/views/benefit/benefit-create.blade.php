				      	...
				      	<div class="card-body">
							<div class="container" id="form_div">
									...
									<div class="form-group row">
                                        <label for="benefit_name" class="col-sm-4 col-form-label" style="font-weight: normal;">Benefit Name<span class="text-danger"><strong>*</strong></span></label>
									    <div class="col-sm-8">
							  		...
							  		<div class="form-group row">
									    <label for="benefit_type" class="col-sm-4 col-form-label" style="font-weight: normal;">Benefit Type<span class="text-danger"><strong>*</strong></span></label>
									    <div class="col-sm-8">
