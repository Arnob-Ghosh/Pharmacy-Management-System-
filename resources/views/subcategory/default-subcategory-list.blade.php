...
@section('title', 'Default Sub-categories')
            ...
            <div class="row">
	          	<div class="col-lg-12">
		              ...
		              <div class="card-header">
		                	<h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> DEFAULT SUB-CATEGORIES</strong></h5>
		              </div>
		              <div class="card-body">
	                    ...
	                    <div class="pt-3">
												<table id="default_subcategory_table" class="display">
												    <thead>
												        <tr>
												            <th>#</th>
