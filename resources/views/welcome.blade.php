                ...
                <div class="col-md-12 col-lg-7 text-center text-lg-left">
                    <div class="main-banner">
                        ...
                        <h4 class="display-4 mb-5" style="color:rgb(31, 158, 103);">
                            <span style="font-size: 75%;"> সর্বাধিক ফিচার সমৃদ্ধ ফার্মেসি</span> <span style="font-size: 75%;"><br> ব্যবসার সেরা  সফটওয়্যার </span>
                        </h4>

                        <!-- Subheading -->
                        <p class="lead mb-4">
                            আমাদের ফার্মেসি ম্যানেজমেন্ট সফ্টওয়্যার, “বিক্রয়িক ফার্মা ”- এর মাধ্যমে আপনার কর্মীদের দক্ষতা, উৎপাদনশীলতা এবং গ্রাহক সেবা দ্রুত  বাড়াতে পারেন। আমাদের সফ্টওয়্যার আপনার কাজের প্রক্রিয়াকে স্বয়ংক্রিয় করতে এবং ব্যবসার উন্নয়ন করতে সহায়তা করে।
                        </p>

                        <!-- Button -->
                        <p class="mb-0">
                            <a href="{{ url('/subscriber-create') }}" target="_blank" class="btn btn-primary btn-circled" style="font-size: 80%;">
                                লাইভ ডেমো
                            </a>
            ...
            <div class="row mb-5">
                <div class="col-lg-12 pl-4 text-lg-center pt-5">
                    <div class="service-heading">
                        <h1>এক নজরে <span style="color: #1f9e67">বিক্রয়িক ফার্মা</span> - এর ফিচার সমূহ: </h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-block media">
                        ...
                        <div class="service-inner-content media-body text-center">
                            ...
                            <p style="font-size: 14px;">জেনেরিক নাম, প্যাকের আকার এবং ওজন সহ আমাদের ফার্মেসি সিস্টেমের সাথে সমস্ত পণ্যগুলি সুনির্দিষ্টভাবে এবং নিরাপদে পরিচালনা করুন। এই সিস্টেমটি শুধুমাত্র অনুমোদিত ব্যবহারকারীদের জন্য পণ্যের তথ্য, ডেটা সুরক্ষিত এবং অ্যাক্সেসযোগ্য রাখতে সাহায্য করে।</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="service-block media">
                        ...
                        <div class="service-inner-content media-body text-center">
                            ...
                            <h4 class="pt-3">মেয়াদোত্তীর্ণ পণ্য ট্র্যাকিং</h4>
                            <p style="font-size: 14px;">ডেডস্টক এবং মেয়াদোত্তীর্ণ ওষুধ পরিচালনায় অসুবিধা এড়াতে, আমাদের সিস্টেম মেয়াদোত্তীর্ণ-তারিখ-ভিত্তিক বিক্রয় বজায় রাখে। কাছাকাছি মেয়াদোত্তীর্ণের তারিখযুক্ত ওষুধগুলি বিক্রয়ের জন্য সামনে সংরক্ষিত থাকবে এবং পরবর্তী মেয়াদ শেষ হওয়ার তারিখের সাথে পিছনে রাখা হবে। </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="service-block media">
                        ...
                        <div class="service-inner-content media-body text-center">
                            ...
                            <p style="font-size: 14px;">নির্দিষ্ট সময়ে আপনার প্রয়োজনীয় সঠিক পণ্যগুলি পেতে আপনার পণ্য সরবরাহকারীর বিক্রেতার সাথে যোগাযোগ করুন।</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-block media">
                        ...
                        <div class="service-inner-content media-body text-center">
                            ...
                            <p style="font-size: 14px;">ওষুধের কম্পিউটারাইজ লেবেলিং, দাম এবং সিস্টেমের মাধ্যমে ওষুধের মেয়াদ শেষ হওয়ার তারিখগুলিও প্রিন্ট করুন।</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
