		              ...
		              <div class="card-body" >
	              		<div class="row">
				            ...
				            <form id="ExpenseReport" method="POST" enctype="multipart/form-data">
				            	...
				            	<h4 class="mb-0 pt-5" style="font"><strong><u>Generate Custom Expense Report</u></strong></h4>
										  ...
										  <div class="row">
										  	<div style="padding-top: 5px;" class="form-group col-md-8">

										      <button id="gen_btn" type="submit" class="btn btn-primary float-right">Generate</button>
										      <button type="reset" value="Reset" class="btn btn-outline-danger float-right mr-2" onclick="resetButton()"><i class="fas fa-eraser"></i> Reset</button>
										    </div>
