		                ...
		                {{-- <div class="row">
				              <div class="col-12 col-sm-6 col-md-6">
				                <div class="info-box">
				                  ...
				                  <div class="info-box-content">
				                    <h6 class="info-box-text mb-1" style=""><strong>Total Sale</strong></h6>
				            ...
				            <div class="row">
				                ...
				                <div class="info-box">
				                  ...
				                  <div class="info-box-content">
				                    <h6 class="info-box-text mb-1" style=""><strong>Total Deposit</strong></h6>
				              ...
				              <div class="col-12 col-sm-6 col-md-6">
				                <div class="info-box">
				                  ...
				                  <div class="info-box-content">
				                    <h6 class="info-box-text mb-1" style=""><strong>Total Due</strong></h6>
		              ...
		              <div class="card-body" >
		                ...
		                <div class="row">
		                	<div class="col-12">
		                		...
		                		<h5><span id="detailDate"></span></h5>
		                		<div class="pt-2">
		                			<table id="deposit_table_details" class="display">
													  <thead>
													    <tr>
													    	<th>#</th>
													      <th>Client</th>
