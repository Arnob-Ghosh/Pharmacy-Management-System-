      			...
      			<div class="col-lg-6">
          			<div class="card card-primary">
			            <div class="card-header">
			                <h5 class="m-0"><strong><i class="fas fa-leaf"></i> LEAF/BOX</strong></h5>
			            </div>
	          				...
	          				<div class="container">
								...
								<form id="AddLeafForm" method="POST" enctype="multipart/form-data">
								  	...
								  	<div class="form-group">
									    <label for="leaftype" class="form-label" style="font-weight: normal;">Leaf/Box Type<span class="text-danger"><strong>*</strong></span></label>
								  	...
								  	<div class="form-group">
									    <label for="totalnumberofperbox" class="form-label" style="font-weight: normal;">Medicine Per Leaf/Box<span class="text-danger"><strong>*</strong></span></label>
