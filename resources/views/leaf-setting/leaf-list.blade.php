...
@section('title', 'Leaf/Box Setting')
            ...
            <div class="row">
	          	<div class="col-lg-12">
		              ...
		              <div class="card-header">
		                	<h5 class="m-0"><strong><i class="fab fa-pagelines"></i> LEAVES/BOXS</strong></h5>
		              </div>
		              <div class="card-body">
		                <!-- <h6 class="card-title">Special title treatment</h6> -->
		                <!-- Table -->

	                	<a href="/leaf-create"><button type="button" class="btn btn-outline-info"><i class="fas fa-plus"></i> Create Leaf/Box</button></a>
