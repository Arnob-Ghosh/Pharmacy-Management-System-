      			...
      			<div class="col-lg-4">
          			<div class="card card-primary">
			            <div class="card-header">
			                <h5 class="m-0"><strong><i class="fas fa-sync-alt"></i> CUSTOMER RETURN</strong></h5>
			            </div>
	          				...
	          				<div class="container">
	          					...
	          					<div class="row">
									<div class="col-12">
										...
										<div class="pt-5 hidden" id="freeItemTableDiv">
	          					...
	          					<div class="row">
	          						<div class="col-3">
		          						<div class="form-group">
		      								<label for="customername" class="col-form-label fw-normal">Customer Name</label>
											<input type="text" class="form-control" name="customername" id="customername" disabled>
											<input type="hidden" class="form-control" name="customerid" id="customerid" disabled>
