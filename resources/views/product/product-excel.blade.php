	          	...
	          	<div class="col-lg-12">
		              ...
		              <div class="card-body">
		              	...
		              	<form action="{{ route('product-excel-import') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <br>
						            <div class="row">
                                        {{-- <div class="col-4 pb-3 pl-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" id="pCheckbox" name="key">
                                                <label class="form-check-label" for="pCheckbox">Store product in Inventory</label>
                                            </div>
                                        </div> --}}
						            	<div class="col-4">
