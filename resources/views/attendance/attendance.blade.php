	          				...
	          				<!-- <div class="container"> -->
	          					<div class="row">
                                      ...
                                      <div class="col-1">
                                        ...
                                        <div class="col-4">
                                          <h6 class="info-box-text mb-0" style=""><strong>Attended</strong></h6>
                                          <h6 class="info-box-text mb-0">Today: <strong><span >{{$presnet_today}}</span></strong> </h6>
                                          <h6 class="info-box-text mb-0">Total employee: <strong><span >{{$total_emp}}</span></strong></h6>
                                        </div>
	          					</div>
